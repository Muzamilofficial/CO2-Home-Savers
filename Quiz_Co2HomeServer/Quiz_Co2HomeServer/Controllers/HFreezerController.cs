...
{
    public class HFreezerController : Controller
    {
        // GET: HFreezer
        ...
        public async Task<ActionResult> Tips()
        {
            try
            {
                ...
                {
                    Prompt = "Generate Energy saving only 1 tip for Freezer Kitchen Appliance without numbering and special charactors",
