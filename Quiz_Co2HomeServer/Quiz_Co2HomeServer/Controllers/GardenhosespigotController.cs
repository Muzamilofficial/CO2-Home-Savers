...
{
    public class GardenhosespigotController : Controller
    {
        // GET: Gardenhosespigot
        ...
        public async Task<ActionResult> Tips()
        {
            try
            {
                ...
                {
                    Prompt = "Generate Energy saving only 1 tip for Garden hose spigot Water Appliance without numbering and special charactors",
