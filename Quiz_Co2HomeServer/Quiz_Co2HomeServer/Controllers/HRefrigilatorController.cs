...
{
    public class HRefrigilatorController : Controller
    {
        // GET: HRefrigilator
        ...
        public async Task<ActionResult> Tips()
        {
            try
            {
                ...
                {
                    Prompt = "Generate Energy saving only 1 tip for Refrigerator Kitchen Appliance without numbering and special charactors",
